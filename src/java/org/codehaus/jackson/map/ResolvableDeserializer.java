 ...
 * after construction and being added to {@link JsonDeserializerProvider},
...
{
    /**
     * Method called after {@link JsonDeserializerProvider} has registered
     ...
     *   is called on.
     */
    public abstract void resolve(JsonDeserializerProvider provider);
}
