...
/**
 * Marker annotation
 * that indicates that the annotated method or field 
 * should be serialized as a raw value (using toString() method)
 ...
 * 
 * <p>Warning: the resulting JSON stream may be invalid depending on your input value.
 * 
 */
