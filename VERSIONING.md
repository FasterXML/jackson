...
All per-component repositories (like [jackson-databind](../../../jackson-databind)) contain branches for major versions 2 and 3 (but not 1); changes from 2.x branches are rolled forward to 3.x branches; reverse is not directly possible
